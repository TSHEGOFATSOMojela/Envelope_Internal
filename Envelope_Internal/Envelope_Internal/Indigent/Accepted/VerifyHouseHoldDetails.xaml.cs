...
namespace Envelope_Internal.Indigent.Accepted
{
	...
	public partial class VerifyHouseHoldDetails : ContentPage
	{
         Indigents indigentDetails;
        public VerifyHouseHoldDetails (Indigents indigentDetails)
		{
			InitializeComponent ();
        ...
        private void listviewContacts_ItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            ...
            Navigation.PushAsync(new HouseHoldDetails(itemSelectedData));
